...
if __name__=="__main__":
    ...
    standard_path = '/data/wangbingbing/COMET/Chinese-CLIP/Dataset/MUGE/test_texts.jsonl'
    # the path of prediction file (eg. example_pred.jsonl)
    # submit_path = sys.argv[2]
    submit_path = ' /data/wangbingbing/COMET/Chinese-CLIP/Dataset/MUGE/test_predictions.jsonl'
